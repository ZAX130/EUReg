...
from models import MdTNet_FRT_Test
...
def main():
    batch_size=6
    val_dir = 'Data/CAMUS2_data/Test/'
    weights = [1, 1, 1, 1]  # loss weights
    dim=12
    layer_nums = 4
    lr = 0.0001
    scaler = [10,10,10,10,10,10]
    # save_dir = 'MdTNet{}layers_{}_unnormrot_{}_flow_{}_sim_{}_bs_{}_lr_{}_dim_{}_scaler_[{},{},{},{},{},{}]/'.format(layer_nums, *weights, batch_size, lr, dim, *scaler)
    save_dir = 'EUReg10/'
    img_size = (32, 192, 192)
    slice_size = (128,128)
    ...
    Initialize model
    '''
    model = MdTNet_FRT_Test(img_size,slice_size, dim=dim)
    model.cuda()

    model_dir = 'experiments/miccai2025/CAMUS_diff/' + save_dir
